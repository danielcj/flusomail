defmodule FlusomailWeb.UserLive.Registration do
  ...
  def mount(_params, _session, socket) do
    changeset = Accounts.User.registration_changeset(%User{}, %{}, validate_unique: false)
  ...
  def handle_event("validate", %{"user" => user_params}, socket) do
    changeset = Accounts.User.registration_changeset(%User{}, user_params, validate_unique: false)
