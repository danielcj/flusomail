defmodule FlusomailWeb.Layouts do
  ...
  """
  attr :flash, :map, required: true, doc: "the map of flash messages"
  attr :current_scope, :map, default: nil, doc: "the current user scope with optional organization"
  slot :inner_block, required: true
    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content flex flex-col">
        ...
        <div class="navbar bg-gradient-to-r from-primary/10 to-secondary/10 backdrop-blur-sm border-b border-primary/20 lg:hidden shadow-sm">
          <div class="flex-none">
            <label for="drawer-toggle" class="btn btn-square btn-ghost drawer-button hover:bg-primary/10">
          ...
          <div class="flex-1">
            <a href={~p"/dashboard"} class="btn btn-ghost text-xl font-bold text-primary">
              <span class="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">FlusoMail</span>
            </a>
          </div>
          <div class="flex-none">
              ...
              <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
                <div class="w-8 rounded-full bg-gradient-to-r from-primary to-secondary flex items-center justify-center">
                  <span class="text-primary-content text-sm font-semibold">
                    {if @current_scope, do: String.first(@current_scope.user.email) |> String.upcase(), else: "U"}
                  </span>
                </div>
              </div>
            </div>
        ...
        <aside class="w-72 min-h-full bg-gradient-to-b from-base-200 via-base-200 to-base-300/50 border-r border-base-300/50 shadow-xl">
          ...
          <div class="hidden lg:flex h-16 items-center px-6 border-b border-base-300/50 bg-gradient-to-r from-primary/5 to-secondary/5">
            <a href={~p"/dashboard"} class="flex items-center space-x-3 group">
              ...
              <span class="text-xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">FlusoMail</span>
            </a>
          </div>
          ...
          <div class="px-4 py-4 border-b border-base-300/50">
            <%= if @current_scope && @current_scope.organization do %>
              <div class="dropdown dropdown-bottom w-full">
                <div tabindex="0" role="button" class="btn btn-ghost w-full justify-between hover:bg-primary/10 transition-colors duration-200 group">
                  <div class="flex items-center space-x-3">
                    <div class="w-6 h-6 bg-gradient-to-r from-primary to-secondary rounded-md flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-primary-content" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <ul tabindex="0" class="dropdown-content menu p-2 shadow-lg bg-base-100 rounded-lg w-64 z-50 border border-base-300">
                  <li><.link navigate={~p"/organizations"} class="hover:bg-primary/10"><span>🔄 Switch Organization</span></.link></li>
                  <li><.link navigate={~p"/organizations/#{@current_scope.organization.id}"} class="hover:bg-primary/10"><span>⚙️ Organization Settings</span></.link></li>
                  <div class="divider my-1"></div>
                  <li><.link navigate={~p"/organizations/new"} class="hover:bg-success/10"><span>➕ Create New</span></.link></li>
                </ul>
              </div>
            <% else %>
              <div class="dropdown dropdown-bottom w-full">
                <div tabindex="0" role="button" class="btn btn-outline btn-warning w-full justify-between hover:bg-warning/10 transition-colors duration-200 group">
                  <div class="flex items-center space-x-3">
                    <div class="w-6 h-6 bg-warning/20 rounded-md flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-warning" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <ul tabindex="0" class="dropdown-content menu p-2 shadow-lg bg-base-100 rounded-lg w-64 z-50 border border-base-300">
                  <li><.link navigate={~p"/organizations"} class="hover:bg-primary/10"><span>🏢 Select Organization</span></.link></li>
                  <li><.link navigate={~p"/organizations/new"} class="hover:bg-success/10"><span>➕ Create New</span></.link></li>
                  <div class="divider my-1"></div>
                  <li><.link navigate={~p"/welcome"} class="hover:bg-info/10"><span>🚀 Setup Wizard</span></.link></li>
                </ul>
              </div>
            <% end %>
          </div>
          ...
          <nav class="flex-1 px-4 py-6 space-y-2">
            <!-- Main Dashboard -->
            <.link navigate={~p"/dashboard"} class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 transition-colors duration-200 group">
              ...
              <span class="font-medium text-base-content group-hover:text-primary transition-colors duration-200">Dashboard</span>
            </.link>

            <!-- Section: Email Management -->
            <div class="pt-6">
              <h3 class="px-3 text-xs font-semibold text-base-content/50 uppercase tracking-wider mb-3">Email Management</h3>

              <.link navigate={~p"/campaigns"} class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 transition-colors duration-200 group">
                ...
                <span class="font-medium text-base-content group-hover:text-primary transition-colors duration-200">Campaigns</span>
              </.link>

              <.link navigate={~p"/templates"} class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 transition-colors duration-200 group">
                ...
                <span class="font-medium text-base-content group-hover:text-primary transition-colors duration-200">Templates</span>
              </.link>

              <.link navigate={~p"/contacts"} class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 transition-colors duration-200 group">
                <div class="w-8 h-8 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-lg flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow duration-200">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 515.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 919.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
                <span class="font-medium text-base-content group-hover:text-primary transition-colors duration-200">Contacts</span>
              </.link>
            </div>

            <!-- Section: Configuration -->
            <div class="pt-6">
              <h3 class="px-3 text-xs font-semibold text-base-content/50 uppercase tracking-wider mb-3">Configuration</h3>

              <.link navigate={~p"/domains"} class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 transition-colors duration-200 group">
                ...
                <span class="font-medium text-base-content group-hover:text-primary transition-colors duration-200">Domains</span>
              </.link>

              <.link navigate={~p"/api-keys"} class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 transition-colors duration-200 group">
                ...
                <span class="font-medium text-base-content group-hover:text-primary transition-colors duration-200">API Keys</span>
              </.link>

              <.link navigate={~p"/webhooks"} class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 transition-colors duration-200 group">
                ...
                <span class="font-medium text-base-content group-hover:text-primary transition-colors duration-200">Webhooks</span>
              </.link>
            </div>

            <!-- Section: Analytics -->
            <div class="pt-6">
              <h3 class="px-3 text-xs font-semibold text-base-content/50 uppercase tracking-wider mb-3">Analytics</h3>

              <.link navigate={~p"/analytics"} class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 transition-colors duration-200 group">
                ...
                <span class="font-medium text-base-content group-hover:text-primary transition-colors duration-200">Analytics</span>
              </.link>

              <.link navigate={~p"/logs"} class="flex items-center space-x-3 px-3 py-2.5 rounded-lg hover:bg-primary/10 transition-colors duration-200 group">
                ...
                <span class="font-medium text-base-content group-hover:text-primary transition-colors duration-200">Email Logs</span>
              </.link>
            </div>
          </nav>
          ...
          <div class="absolute bottom-0 w-full border-t border-base-300/50 bg-gradient-to-r from-base-200/50 to-base-300/30 p-4">
            <div class="dropdown dropdown-top w-full">
              <div tabindex="0" role="button" class="btn btn-ghost w-full justify-start hover:bg-primary/10 transition-colors duration-200 group">
              ...
              <ul tabindex="0" class="dropdown-content menu p-2 shadow-lg bg-base-100 rounded-lg w-64 z-50 border border-base-300 mb-2">
                <li><.link navigate={~p"/users/settings"} class="hover:bg-primary/10 flex items-center space-x-2"><span>⚙️</span><span>Account Settings</span></.link></li>
                <div class="divider my-1"></div>
                <li><.link href={~p"/users/log-out"} method="delete" class="hover:bg-error/10 text-error flex items-center space-x-2"><span>🚪</span><span>Sign Out</span></.link></li>
              </ul>
            </div>
          </div>
        </aside>
