defmodule Flusomail.Accounts do
  @moduledoc """
  ...
  alias Flusomail.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Flusomail.Accounts.User.password_changeset/3` for a list of supported options.
