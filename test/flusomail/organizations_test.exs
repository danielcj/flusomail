defmodule Flusomail.OrganizationsTest do
  ...
  describe "organizations" do
    ...
    @invalid_attrs %{name: nil, status: nil, plan: nil, slug: nil, settings: nil, billing_email: nil}
    ...
    test "create_organization/2 with valid data creates a organization" do
      valid_attrs = %{name: "some name", status: "some status", plan: "some plan", slug: "some-slug", settings: %{}, billing_email: "some billing_email"}
      scope = user_scope_fixture()
    ...
    test "update_organization/3 with valid data updates the organization" do
      scope = user_scope_fixture()
      organization = organization_fixture(scope)
      update_attrs = %{name: "some updated name", status: "some updated status", plan: "some updated plan", slug: "some-updated-slug", settings: %{}, billing_email: "some updated billing_email"}
